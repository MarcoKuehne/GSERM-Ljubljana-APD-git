...
# rthe package is installed or not, (b) installs it if it is not, and 
...
tiny<-read_table("https://raw.githubusercontent.com/PrisonRodeo/GSERM-Ljubljana-APD-git/master/Data/tinyTSCSexample.txt")
tiny
...
SCDBVotes<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/GSERM-Ljubljana-APD-git/master/Data/SCDB-2020.csv")
...
SegalCover<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/GSERM-Ljubljana-APD-git/master/Data/Segal-Cover.csv")
