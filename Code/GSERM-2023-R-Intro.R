...
#
# File last updated December 23, 2022
#
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# OBJECTS                           #########
#
...
setwd("~/Dropbox (Personal)/GSERM/Ljubljana-2023")
...
SCOTUS <- read_csv("https://raw.githubusercontent.com/PrisonRodeo/GSERM-Ljubljana-APD/master/Data/SCOTUS-votes.csv")
